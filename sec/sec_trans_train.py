...
from data_swin import get_loader
...
from options_final_trans import opt
from options_dut_final_trans import opt as opt_dut
...
#load data
print('load data....')
train_loader_hr = get_loader(image_root, gt_root,gtp_root, batchsize=4, trainsize=384,hr=1280,need_name=True,need_edge=True)
train_loader = get_loader(image_root, gt_root,gtp_root, batchsize=16, trainsize=256)


train_loader_hr_w = get_loader(image_root_w, gt_root_w,gtp_root_w, batchsize=24, trainsize=384,hr=512,need_name=True,need_edge=True)
